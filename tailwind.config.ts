  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'sm': ['clamp(0.875rem, 0.825rem + 0.25vw, 1rem)', { lineHeight: '1.25rem' }],
        ...
        '3xl': ['clamp(1.875rem, 1.65rem + 1.125vw, 2.25rem)', { lineHeight: '2.25rem' }],
        '4xl': ['clamp(2.25rem, 1.95rem + 1.5vw, 3rem)', { lineHeight: '2.5rem' }],
      },
      borderRadius: {
        lg: 'var(--radius)',
