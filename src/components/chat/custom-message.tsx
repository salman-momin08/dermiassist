...
import { MessageSimple, MessageSimpleProps, useChatContext, useMessageContext } from 'stream-chat-react';
...
interface CustomMessageProps extends MessageSimpleProps {
