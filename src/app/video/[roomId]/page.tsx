  ...
  useEffect(() => {
    ...
    const setupAndJoin = async () => {
      ...
      try {
        ...
        await agoraClient.join(process.env.NEXT_PUBLIC_AGORA_APP_ID!, roomId, fetchedToken, user.uid);
     ...
     return (
       <div className="flex h-screen w-full flex-col items-center justify-center bg-background p-4">
        <Alert variant="destructive" className="max-w-md text-center">
          ...
          <AlertDescription>
              SkinWise needs access to your camera and microphone. Please enable permissions in your browser settings and refresh the page.
          </AlertDescription>
