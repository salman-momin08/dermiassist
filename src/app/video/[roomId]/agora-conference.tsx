...
// Owns the Agora client + provider so the whole SDK stays inside this
// dynamically-imported (ssr:false) chunk, out of the main route bundle.
export default function AgoraConference() {
