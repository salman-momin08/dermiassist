...
const ChatEventListeners = () => {
    ...
    const handleEvent = useCallback((event: any) => {
        if (event.type === 'message.deleted') {
            ...
            // This listener is more for soft deletes or other custom events
        }
...
const CustomChannelHeader = () => {
    ...
    const goBack = () => {
        // This is a bit of a hack to deselect the channel on mobile
        // A more robust solution might involve custom state management
